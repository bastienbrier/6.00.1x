...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        text = self.createSpace(text)
        text = text.lower()
        return self.word in text.split()
    
    def createSpace(self, text):
...
def main_thread(master):
    ...
    try:
        ...
        triggerlist = readTriggerConfig("/Users/bastienbrier/Documents/edX/MIT/6.00.1x/Week 7/Problem Set 7/triggers.txt")
